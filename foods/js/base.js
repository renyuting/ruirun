...
$(function () {
    ...
    // 模拟数据
    /*if (!isWeiXin()) {
        storage('avatarUrl', '../../images/pic.png');  // 用户头像
        storage('nickName', '叫小餐'); // 用户名称
        storage('customerUuid', '25be8a1710f542abadff8f18da4d9557')  // 会员id
    }*/
    //storage('vendorUuid', 'ad7dc50c662f4118a502ac123773c022');  // 商户id
    //storage('styleClass', 'orange')  // 商户皮肤值
});
